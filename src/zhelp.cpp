...
int main() 
{std::cout << "\033[1;31mZielina Package Manager\033[0m TESTING" << std::endl;
//colors
...
std::cout << "\033[1mzrm\033[0m - Remove package, Usage: zrm [package name], Agr -f -p" << std::endl;
...
std::cout << "zrm -f (flatpak) -p (purge)" <<std::endl;
return 0;
}
